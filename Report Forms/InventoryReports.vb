Public Class InventoryReports
    ...
    Private Sub GunaButton1_Click(sender As Object, e As EventArgs) Handles GunaButton3.Click, GunaButton1.Click
        Me.PtDateFilter1.IsBlankDate = True
        isProceedPrint = True
    End Sub

    Private Sub InventoryReports_Load(sender As Object, e As EventArgs) Handles Me.Load
        PtDateFilter1.cboFilterType.Text = "As Of"
    End Sub
End Class

...
Partial Class StockEntry
    ...
    Private Sub InitializeComponent()
        ...
        'txtModule
        '
        Me.txtModule.EditValue = "STOCKENTRY"
    ...
    "= pk_invty |order by id_ldgrinvty"
        ...
        Me.sg__transaction_ledger_entries.TabIndex = 2
    ...
    "sh desc, id_transh desc"
        Me.TransactionType = NewTemplate.TransactionBase.TransactionTypesEnum.StockEntry

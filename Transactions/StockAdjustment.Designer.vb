...
Partial Class StockAdjustment
    ...
    Private Sub InitializeComponent()
        ...
        'lblHeaderTitle
        '
        Me.lblHeaderTitle.Text = "STOCK ADJUSTMENT"
        '
        ...
        'txtModule
        '
        Me.txtModule.EditValue = "StockAdj"
    ...
    "= pk_invty |order by id_ldgrinvty"
        ...
        Me.sg__transaction_ledger_entries.TabIndex = 4
    ...
    "IsPurchaseUnit_InvtyU = 1 |order by description_invty"
        ...
        Me.SearchFormTableFromInfo = "|from transaction_headers |where module_transh = 'stockadjustment' |order by date" &
    "_transh desc, id_transh desc"
        Me.TransactionType = NewTemplate.TransactionBase.TransactionTypesEnum.StockAdjustment

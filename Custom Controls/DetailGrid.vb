...
Public Class DetailGrid : Inherits SearchGrid
    ...
    <DefaultValue(False)>
    Public Property GLEnabled() As Boolean
        Get
            Return _GLEnabled
        End Get
        Set(ByVal value As Boolean)
    ...
    Private Sub AfterLoadGDetails(ByVal gridname As String)
        RaiseEvent AfterLoadGridDetails(gridname)
    End Sub

...
Public Class ApplicationSettings
    ...
    Public Sub LoadDBSettings()
        ...
        Dim tmpUserName As String, tmpPassword As String, tmpHostName As String, tmpPort As String, tmpDatabaseName As String
        ...
        With ApplicationSettings.Instance
            ...
            tmpPort = .GetSettings(xbasePath + "Port", "Value")
            ...
            If Not IsEmptyString(tmpHostName) AndAlso Not IsEmptyString(tmpDatabaseName) _
                ...
                DBConnectionString = "server=" + tmpHostName + ";database=" + tmpDatabaseName + ";user id=" + tmpUserName + ";password=" + tmpPassword + ";port=" + tmpPort
            Else
                DBConnectionString = ""
            End If
    ...
    Public Function GetConnectionStringFromRegistry() As String
        ...
        Try
            ...
            Dim dbport As String = tripleDES.Decrypt(GetValueFromRegistry("Database Settings", "Port"))
            ...
            connString = String.Format("server={0};database={1};user id={2};password={3};port={4};Old Guids=true;Pooling=False;Connection Timeout=10000;", dbserver, dbname, dbuser, dbpass, dbport)

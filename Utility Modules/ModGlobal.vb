...
Public Module ModGlobal
    ...
    Public AppMainForm As MainForm
    ...
    Public ControlTypes() As String = New String() {"textinput", "userpkinput", "comboboxinput", "gridlookupedit", "memoinput", "dateedit", "pictureedit"}

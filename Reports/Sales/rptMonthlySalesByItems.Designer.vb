...
Partial Public Class rptMonthlySalesByItems
    Inherits NewTemplate.ReportBaseLandscape
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(rptMonthlySalesByItems))
        ...
        Me.Detail.SortFields.AddRange(New DevExpress.XtraReports.UI.GroupField() {New DevExpress.XtraReports.UI.GroupField("YEAR(Date_TransH)", DevExpress.XtraReports.UI.XRColumnSortOrder.Ascending)})
        '
        'PageHeader
        '
        ...
        'GroupHeader1
        '
        Me.GroupHeader1.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.ReportLabel1})
        Me.GroupHeader1.GroupFields.AddRange(New DevExpress.XtraReports.UI.GroupField() {New DevExpress.XtraReports.UI.GroupField("YEAR(Date_TransH)", DevExpress.XtraReports.UI.XRColumnSortOrder.Ascending)})
        Me.GroupHeader1.HeightF = 13.00001!
        ...
        'XrPageInfo1
        '
        Me.XrPageInfo1.LocationFloat = New DevExpress.Utils.PointFloat(1305.083!, 21.99999!)
        ...
        Me.ReportTable1.Font = New System.Drawing.Font("Verdana", 7.0!)
        ...
        Me.ReportTable1.SizeF = New System.Drawing.SizeF(1375.0!, 20.0!)
        ...
        'XrTableRow1
        '
        Me.XrTableRow1.Cells.AddRange(New DevExpress.XtraReports.UI.XRTableCell() {Me.XrTableCell15, Me.XrTableCell14, Me.XrTableCell1, Me.XrTableCell2, Me.XrTableCell3, Me.XrTableCell4, Me.XrTableCell5, Me.XrTableCell6, Me.XrTableCell7, Me.XrTableCell8, Me.XrTableCell9, Me.XrTableCell10, Me.XrTableCell11, Me.XrTableCell12, Me.XrTableCell13})
        ...
        Me.XrTableCell15.Weight = 2.9090827119274216R
        '
        'XrTableCell14
        '
        ...
        Me.XrTableCell14.Text = "YEAR"
        Me.XrTableCell14.Weight = 0.65750559437101486R
        '
        'XrTableCell1
        '
        Me.XrTableCell1.Name = "XrTableCell1"
        Me.XrTableCell1.Padding = New DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100.0!)
        Me.XrTableCell1.Text = "JANUARY"
        ...
        Me.XrTableCell9.Text = "SEPTEMBER"
        ...
        Me.XrTableCell11.Text = "NOVEMBER"
        ...
        Me.XrTableCell12.Text = "DECEMBER"
        ...
        Me.XrTableCell13.Weight = 1.1775903159270762R
        '
        'ReportTable2
        '
        ...
        Me.ReportTable2.Font = New System.Drawing.Font("Verdana", 7.0!)
        ...
        Me.ReportTable2.SizeF = New System.Drawing.SizeF(1375.0!, 20.0!)
        ...
        Me.ReportTable2.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter
        '
        'XrTableRow2
        '
        ...
        Me.XrTableCell16.Tag = "Description_Invty"
        Me.XrTableCell16.Text = "ITEM"
        Me.XrTableCell16.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft
        Me.XrTableCell16.Weight = 2.9090827119274216R
        '
        'XrTableCell17
        '
        Me.XrTableCell17.Font = New System.Drawing.Font("Verdana", 7.0!, System.Drawing.FontStyle.Bold)
        Me.XrTableCell17.Name = "XrTableCell17"
        Me.XrTableCell17.Padding = New DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100.0!)
        Me.XrTableCell17.StylePriority.UseFont = False
        Me.XrTableCell17.StylePriority.UsePadding = False
        Me.XrTableCell17.Tag = "YEAR(Date_TransH)"
        Me.XrTableCell17.Text = "YEAR"
        Me.XrTableCell17.Weight = 0.65750559437101486R
        '
        'XrTableCell18
        '
        ...
        Me.XrTableCell18.Tag = "SUM(CASE WHEN MONTH(Date_TransH) = 1 THEN TotalAmount_LdgrInvty ELSE 0 END)"
        Me.XrTableCell18.Text = "JANUARY"
        ...
        Me.XrTableCell19.Tag = "SUM(CASE WHEN MONTH(Date_TransH) = 2 THEN TotalAmount_LdgrInvty ELSE 0 END)"
        Me.XrTableCell19.Text = "FEBRUARY"
        ...
        Me.XrTableCell20.Tag = "SUM(CASE WHEN MONTH(Date_TransH) = 3 THEN TotalAmount_LdgrInvty ELSE 0 END)"
        Me.XrTableCell20.Text = "MARCH"
        ...
        Me.XrTableCell21.Tag = "SUM(CASE WHEN MONTH(Date_TransH) = 4 THEN TotalAmount_LdgrInvty ELSE 0 END)"
        Me.XrTableCell21.Text = "APRIL"
        ...
        Me.XrTableCell22.Tag = "SUM(CASE WHEN MONTH(Date_TransH) = 5 THEN TotalAmount_LdgrInvty ELSE 0 END)"
        Me.XrTableCell22.Text = "MAY"
        ...
        Me.XrTableCell23.Tag = "SUM(CASE WHEN MONTH(Date_TransH) = 6 THEN TotalAmount_LdgrInvty ELSE 0 END)"
        Me.XrTableCell23.Text = "JUNE"
        ...
        Me.XrTableCell24.Tag = "SUM(CASE WHEN MONTH(Date_TransH) = 7 THEN TotalAmount_LdgrInvty ELSE 0 END)"
        Me.XrTableCell24.Text = "JULY"
        ...
        Me.XrTableCell25.Tag = "SUM(CASE WHEN MONTH(Date_TransH) = 8 THEN TotalAmount_LdgrInvty ELSE 0 END)"
        Me.XrTableCell25.Text = "AUGUST"
        ...
        Me.XrTableCell26.Tag = "SUM(CASE WHEN MONTH(Date_TransH) = 9 THEN TotalAmount_LdgrInvty ELSE 0 END)"
        Me.XrTableCell26.Text = "SEPTEMBER"
        ...
        Me.XrTableCell27.Tag = "SUM(CASE WHEN MONTH(Date_TransH) = 10 THEN TotalAmount_LdgrInvty ELSE 0 END)"
        Me.XrTableCell27.Text = "OCTOBER"
        ...
        Me.XrTableCell28.Tag = "SUM(CASE WHEN MONTH(Date_TransH) = 11 THEN TotalAmount_LdgrInvty ELSE 0 END)"
        Me.XrTableCell28.Text = "NOVEMBER"
        ...
        Me.XrTableCell29.Tag = "SUM(CASE WHEN MONTH(Date_TransH) = 12 THEN TotalAmount_LdgrInvty ELSE 0 END)"
        Me.XrTableCell29.Text = "DECEMBER"
        ...
        Me.XrTableCell30.Tag = "SUM(TotalAmount_LdgrInvty)"
        Me.XrTableCell30.Text = "TOTAL AMOUNT"
        Me.XrTableCell30.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleRight
        Me.XrTableCell30.TextFormatString = "{0:n2}"
        Me.XrTableCell30.Weight = 1.1775903159270762R
        '
        'ReportLabel1
        '
        Me.ReportLabel1.FieldName = Nothing
        Me.ReportLabel1.LocationFloat = New DevExpress.Utils.PointFloat(10.00001!, 0!)
        Me.ReportLabel1.Name = "ReportLabel1"
        Me.ReportLabel1.Padding = New DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100.0!)
        Me.ReportLabel1.SizeF = New System.Drawing.SizeF(100.0!, 13.00001!)
        Me.ReportLabel1.Tag = "YEAR(Date_TransH)"
        Me.ReportLabel1.Text = "YEAR(Date_TransH)"
        '
        'ReportFooter
        '
        Me.ReportFooter.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.ReportTable3})
        Me.ReportFooter.HeightF = 20.0!
        Me.ReportFooter.Name = "ReportFooter"
        '
        'ReportTable3
        '
        Me.ReportTable3.BackColor = System.Drawing.Color.Transparent
        Me.ReportTable3.Borders = CType(((DevExpress.XtraPrinting.BorderSide.Left Or DevExpress.XtraPrinting.BorderSide.Right) _
            Or DevExpress.XtraPrinting.BorderSide.Bottom), DevExpress.XtraPrinting.BorderSide)
        Me.ReportTable3.FieldName = Nothing
        Me.ReportTable3.Font = New System.Drawing.Font("Verdana", 6.8!, System.Drawing.FontStyle.Bold)
        ...
        Me.ReportTable3.SizeF = New System.Drawing.SizeF(1375.0!, 20.0!)
        ...
        Me.ReportTable3.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter
        '
        'XrTableRow3
        '
        Me.XrTableRow3.Cells.AddRange(New DevExpress.XtraReports.UI.XRTableCell() {Me.XrTableCell31, Me.XrTableCell33, Me.XrTableCell34, Me.XrTableCell35, Me.XrTableCell36, Me.XrTableCell37, Me.XrTableCell38, Me.XrTableCell39, Me.XrTableCell40, Me.XrTableCell41, Me.XrTableCell42, Me.XrTableCell43, Me.XrTableCell44, Me.XrTableCell45})
        ...
        Me.XrTableCell31.Weight = 3.5665890886634517R
        '
        'XrTableCell33
        '
        ...
        Me.XrTableCell33.Summary = XrSummary1
        Me.XrTableCell33.Tag = "SUM(CASE WHEN MONTH(Date_TransH) = 1 THEN TotalAmount_LdgrInvty ELSE 0 END)"
        Me.XrTableCell33.Text = "JANUARY"
        ...
        Me.XrTableCell34.Tag = "SUM(CASE WHEN MONTH(Date_TransH) = 2 THEN TotalAmount_LdgrInvty ELSE 0 END)"
        Me.XrTableCell34.Text = "FEBRUARY"
        ...
        Me.XrTableCell35.Summary = XrSummary3
        Me.XrTableCell35.Tag = "SUM(CASE WHEN MONTH(Date_TransH) = 3 THEN TotalAmount_LdgrInvty ELSE 0 END)"
        Me.XrTableCell35.Text = "MARCH"
        ...
        Me.XrTableCell36.Summary = XrSummary4
        Me.XrTableCell36.Tag = "SUM(CASE WHEN MONTH(Date_TransH) = 4 THEN TotalAmount_LdgrInvty ELSE 0 END)"
        Me.XrTableCell36.Text = "APRIL"
        ...
        Me.XrTableCell37.Summary = XrSummary5
        Me.XrTableCell37.Tag = "SUM(CASE WHEN MONTH(Date_TransH) = 5 THEN TotalAmount_LdgrInvty ELSE 0 END)"
        Me.XrTableCell37.Text = "MAY"
        ...
        Me.XrTableCell38.Tag = "SUM(CASE WHEN MONTH(Date_TransH) = 6 THEN TotalAmount_LdgrInvty ELSE 0 END)"
        Me.XrTableCell38.Text = "JUNE"
        Me.XrTableCell38.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleRight
        Me.XrTableCell38.TextFormatString = "{0:n2}"
        ...
        Me.XrTableCell39.Tag = "SUM(CASE WHEN MONTH(Date_TransH) = 7 THEN TotalAmount_LdgrInvty ELSE 0 END)"
        Me.XrTableCell39.Text = "JULY"
        Me.XrTableCell39.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleRight
        Me.XrTableCell39.TextFormatString = "{0:n2}"
        ...
        Me.XrTableCell40.Tag = "SUM(CASE WHEN MONTH(Date_TransH) = 8 THEN TotalAmount_LdgrInvty ELSE 0 END)"
        Me.XrTableCell40.Text = "AUGUST"
        ...
        Me.XrTableCell41.Tag = "SUM(CASE WHEN MONTH(Date_TransH) = 9 THEN TotalAmount_LdgrInvty ELSE 0 END)"
        Me.XrTableCell41.Text = "SEPTEMBER"
        ...
        Me.XrTableCell42.Tag = "SUM(CASE WHEN MONTH(Date_TransH) = 10 THEN TotalAmount_LdgrInvty ELSE 0 END)"
        Me.XrTableCell42.Text = "OCTOBER"
        ...
        Me.XrTableCell43.Tag = "SUM(CASE WHEN MONTH(Date_TransH) = 11 THEN TotalAmount_LdgrInvty ELSE 0 END)"
        Me.XrTableCell43.Text = "NOVEMBER"
        ...
        Me.XrTableCell44.Summary = XrSummary12
        Me.XrTableCell44.Tag = "SUM(CASE WHEN MONTH(Date_TransH) = 12 THEN TotalAmount_LdgrInvty ELSE 0 END)"
        Me.XrTableCell44.Text = "DECEMBER"
        ...
        Me.XrTableCell45.Tag = "SUM(TotalAmount_LdgrInvty)"
        Me.XrTableCell45.Text = "TOTAL AMOUNT"
        Me.XrTableCell45.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleRight
        Me.XrTableCell45.TextFormatString = "{0:n2}"
        Me.XrTableCell45.Weight = 1.1775903159270762R
        '
        'rptMonthlySalesByItems
        '
        Me.Bands.AddRange(New DevExpress.XtraReports.UI.Band() {Me.Detail, Me.BottomMargin, Me.PageHeader, Me.GroupHeader1, Me.ReportHeader, Me.TopMargin, Me.PageFooter, Me.ReportFooter})

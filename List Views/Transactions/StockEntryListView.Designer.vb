...
Partial Class StockEntryListView
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(StockEntryListView))
        ...
        'lblHeaderTitle
        '
        Me.lblHeaderTitle.Text = "STOCK ENTRY"
        '
        'SearchBox
        '
        ...
        'StockEntryListView
        '
        Me.AddNewForm = "StockEntry"
        Me.AutoScaleDimensions = New System.Drawing.SizeF(6.0!, 13.0!)
        Me.ClientSize = New System.Drawing.Size(1215, 489)
        Me.Name = "StockEntryListView"
        Me.RecordPKCell = "PK_TransH"
        Me.SearchFormColumnDefinitionInfo = resources.GetString("$this.SearchFormColumnDefinitionInfo")
        Me.SearchFormTableFromInfo = "|from transaction_headers |where module_transh = 'stockentry' |order by date_tran" &
    "sh desc, id_transh desc"
